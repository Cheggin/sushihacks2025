...
const PageLayout: React.FC<PageLayoutProps> = ({ title, rightText, children }) => {
  ...
  return (
    <div className="rounded-3xl backdrop-blur-xl border border-[var(--color-border)] shadow-xl p-6 h-full flex flex-col overflow-hidden page-content bg-slate-900/30">
      {/* Header */}
